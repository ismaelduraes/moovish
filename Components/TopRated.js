...
import {Text, ScrollView, StyleSheet, Animated} from 'react-native';
...
export default function TopRated() {
  ...
  function fetchData() {
    ...
    ).then(result => result.json().then(data => setTopRated(data.results)));
  }
  ...
  return (
    <Animated.View style={styles.container}>
      ...
      <ScrollView
        ...
        horizontal>
        {topRated.splice(0, 10).map((item, index) => {
