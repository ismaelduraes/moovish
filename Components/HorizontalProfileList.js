...
import {View, Image, Text, StyleSheet, FlatList, Touchable} from 'react-native';
...
export default function HorizontalProfileList({
  data,
  title = 'Untitled List',
  showCharacter = false,
}) {
      ...
      <FlatList
        ...
        renderItem={item => {
          return (
            <Pressable
              onPress={() =>
                navigation.push('profile', {profileId: item.item.id})
              }
